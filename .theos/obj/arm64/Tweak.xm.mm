...
@class SBLockHardwareButton; @class BSPlatform; @class SBFHomeGrabberSettings; @class SBPressGestureRecognizer; @class SBVolumeHardwareButton; @class _UIStatusBarVisualProvider_RoundedPad_ForcedCellular; @class CSTeachableMomentsContainerView; @class SBClickGestureRecognizer; @class MTLumaDodgePillSettings; @class UIKeyboardImpl; @class SBHomeHardwareButtonActions; @class SBLockHardwareButtonActions; @class _UIStatusBarVisualProvider_Pad_ForcedCellular; @class SBHomeHardwareButton; @class CCUIHeaderPocketView; @class UITraitCollection; @class _UIStatusBarVisualProvider_iOS; 
