...
@class CCUIStatusBarStyleSnapshot; @class CCSControlCenterDefaults; @class UITraitCollection; @class CCUIModularControlCenterOverlayViewController; @class SBControlCenterController; @class SBHomeGestureSettings; @class UIStatusBarForegroundView; @class CCUIModularControlCenterViewController; @class CCUIOverlayStatusBarPresentationProvider; 
