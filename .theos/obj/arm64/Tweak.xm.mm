...
@class CCUIHeaderPocketView; @class _UIStatusBarVisualProvider_RoundedPad_ForcedCellular; @class BSPlatform; @class SBHomeHardwareButton; @class SBPressGestureRecognizer; @class MTLumaDodgePillSettings; @class UITraitCollection; @class SBLockHardwareButtonActions; @class CSTeachableMomentsContainerView; @class _UIStatusBarVisualProvider_Pad_ForcedCellular; @class SBFHomeGrabberSettings; @class SBClickGestureRecognizer; @class SBHomeHardwareButtonActions; @class _UIStatusBarVisualProvider_iOS; @class SBVolumeHardwareButton; @class SBLockHardwareButton; 
