...
@class CCUIHeaderPocketView; @class BSPlatform; @class UITraitCollection; @class SBClickGestureRecognizer; @class SBHomeHardwareButton; @class _UIStatusBarVisualProvider_Pad_ForcedCellular; @class SBHomeHardwareButtonActions; @class SBFHomeGrabberSettings; @class SBLockHardwareButton; @class _UIStatusBarVisualProvider_RoundedPad_ForcedCellular; @class MTLumaDodgePillSettings; @class CSTeachableMomentsContainerView; @class _UIStatusBarVisualProvider_iOS; @class SBLockHardwareButtonActions; @class SBPressGestureRecognizer; @class SBVolumeHardwareButton; 
