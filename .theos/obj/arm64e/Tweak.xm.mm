...
@class SBFHomeGrabberSettings; @class _UIStatusBarVisualProvider_iOS; @class SBVolumeHardwareButton; @class SBHomeHardwareButtonActions; @class UITraitCollection; @class CCUIHeaderPocketView; @class SBPressGestureRecognizer; @class _UIStatusBarVisualProvider_Pad_ForcedCellular; @class SBHomeHardwareButton; @class MTLumaDodgePillSettings; @class CSTeachableMomentsContainerView; @class SBLockHardwareButtonActions; @class SBClickGestureRecognizer; @class SBLockHardwareButton; @class _UIStatusBarVisualProvider_RoundedPad_ForcedCellular; @class BSPlatform; 
